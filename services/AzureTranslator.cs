...
public static class AzureTranslator
{
  ...
  public static async Task Translate()
  {
    ...
    string path = Path.Combine(Directory.GetCurrentDirectory(), "data", "content.json");
    ...
    foreach (var content in contents)
    {
      ...
      using (var request = new HttpRequestMessage())
      {
        ...
        request.Headers.Add("Ocp-Apim-Subscription-Key", AzureSecrets.AZURE_CS_KEY);
    ...
    File.WriteAllText(Path.Combine(
      Directory.GetCurrentDirectory(), "data", "translations.json"),
